...
Write-Host "✓ Tenants collection created!" -ForegroundColor Green
...
Write-Host "✓ Tenants indexes created!" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Categories indexes created!" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Products indexes created!" -ForegroundColor Green
Write-Host ""
...
Write-Host "  ✓ tenants (8 attributes, 2 indexes)" -ForegroundColor White
Write-Host "  ✓ categories (5 attributes, 2 indexes)" -ForegroundColor White
Write-Host "  ✓ products (9 attributes, 4 indexes)" -ForegroundColor White
Write-Host ""
Write-Host "⚠️  IMPORTANT: Set Collection Permissions Manually" -ForegroundColor Yellow
Write-Host ""
