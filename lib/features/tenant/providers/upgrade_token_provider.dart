...
class UpgradeTokenNotifier extends StateNotifier<Map<String, UpgradeToken>> {
  ...
  String generateToken({
    ...
    print('✅ [TOKEN] Generated upgrade token for $userEmail');
  ...
  UpgradeToken? validateToken(String tokenString) {
    ...
    if (token == null) {
      print('❌ [TOKEN] Token not found: $tokenString');
      return null;
    }

    if (token.isExpired) {
      print('❌ [TOKEN] Token expired: $tokenString');
      return null;
    }

    if (token.isUsed) {
      print('❌ [TOKEN] Token already used: $tokenString');
      return null;
    }

    print('✅ [TOKEN] Token valid for user: ${token.userEmail}');
    return token;
  }
  ...
  void markTokenAsUsed(String tokenString) {
    ...
    if (token != null) {
      ...
      print('✅ [TOKEN] Token marked as used: $tokenString');
    }
  }
  ...
  void clearExpiredTokens() {
    ...
    print('🧹 [TOKEN] Cleared expired tokens');
  }
}
